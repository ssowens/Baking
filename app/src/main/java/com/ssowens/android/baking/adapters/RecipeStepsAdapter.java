...
import com.ssowens.android.baking.databinding.RecipeStepsItemBinding;
...
public class RecipeStepsAdapter extends RecyclerView.Adapter<RecipeStepsAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        RecipeStepsItemBinding recipeStepsItemBinding = RecipeStepsItemBinding.inflate
                (layoutInflater,
                        parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private final RecipeStepsItemBinding binding;

        public MyViewHolder(final RecipeStepsItemBinding binding) {
